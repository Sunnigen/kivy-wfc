...
class Map(Scatter):
    ...
    def __init__(self, x_max, y_max, tile_size, tile_set_file, **kwargs):
        ...
        # ---Initial Variables---
        self.tile_set_loaded = False
        self.x_max = x_max
        self.y_max = y_max
        self.tileset_file = 'data/' + tile_set_file
        self.tile_size = tile_size

        self.lbl_stats = None  # place holder for parents label entropy
        self.lbl_current = None  # place holder for current selection
        self.prob_palette = None  # place holder for probability palette
        self.tile_palette = None  # place holder for tile palette
        self.border_len = 1  # space between tiles
    ...
    def print_stats(self):
        ...
        print('Lowest Entropy:', self.lowest_entropy)

        print('\nGeneration Stats:')
        print('tile_chosen_from_weighted_probabilities:', self.tile_chosen_from_weighted_probabilities)
        print('tile_chosen_randomly:', self.tile_chosen_randomly)
        print('probability_reset:', self.probability_reset)
    ...
    def center_map(self):
        self.scale = 6.0
        self.size = ((self.x_max * self.tile_size) + self.x_max, (self.y_max * self.tile_size) + self.y_max)
